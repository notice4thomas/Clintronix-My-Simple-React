...
var ButtonBase = _react.default.forwardRef(function ButtonBase(props, ref) {
  ...
  return _react.default.createElement(ComponentProp, _extends({
    className: (0, _clsx2.default)(classes.root, (_clsx = {}, _defineProperty(_clsx, classes.disabled, disabled), _defineProperty(_clsx, classes.focusVisible, focusVisible), _defineProperty(_clsx, focusVisibleClassName, focusVisible), _clsx), className),
    onBlur: handleBlur,
    onClick: onClick,
    onFocus: handleFocus,
  ...
  }, buttonProps, other), children, !disableRipple && !disabled ? _react.default.createElement(_NoSsr.default, null, _react.default.createElement(_TouchRipple.default, _extends({
    ref: rippleRef,
    center: centerRipple
